...
const Home=()=>{
    ...
    <div name='Home' className='h-screen w-full bg-gradient-to-b from-black via-black to-gray-800 text-white'>
        <div className='max-w-screen-xl   mx-auto flex flex-col text-left items-center justify-center pt-14 md:pt-0 h-screen px-4 md:flex-row'>
            <div className=' w-full md:ml-32 '>
                ...
                <div className='mx-auto md:mx-0'>
                    <Link to='Portfolio' smooth duration={500} id='spacing-letter' className='group flex  justify-center items-center   md:px-4 my-2 md:my-4 py-2 w-1/2 md:w-2/3 lg:w-1/3 cursor-pointer rounded bg-gradient-to-r from-gray-600 to-gray-500 '>
                        My Projects
            ...
            <div  className="">
                <img src={myImg}   alt="my profile " className='rounded-2xl mt-5 md:mt-0  mx-auto w-2/3 md:w-2/3  ' />
    ...
    //         <div className='flex flex-col increase-width justify-center min-w-fit  md:mt-0'>
    ...
    //         </div>
    //         <div>
    //             <Link to='Portfolio' smooth duration={500} id='spacing-letter' className='group flex   justify-center items-center   md:px-4 my-2 md:my-4 py-2 w-1/3 md:w-1/2 cursor-pointer rounded bg-gradient-to-r from-gray-600 to-gray-500 '>
    //                     My Projects
    //                      <span className='group-hover:rotate-90 duration-300 '>
    //                          <BsArrowRightShort size={30}/>
    //                      </span>
